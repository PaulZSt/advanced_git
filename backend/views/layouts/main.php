                ...
                <ul class="nav navbar-nav">
                                ...
                                <ul class="menu">
                                    <li><!-- start message -->
                                        <a href="#">
                                            <div class="pull-left">
                                                <!-- User Image -->
                                                <img src="<?= Yii::$app->params['adminImage']; ?><?=Yii::$app->user->identity->photo; ?>" class="img-circle" alt="User Image">
                    ...
                    <li class="dropdown user user-menu">
                        ...
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            ...
                            <img src="<?= Yii::$app->params['adminImage']; ?><?=Yii::$app->user->identity->photo; ?>" class="user-image" alt="User Image">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-header">
                                ...
                                <p>
                                    Pavlo Petrovskyi - Web Developer
    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <!--<li><a href="/admin/comments"><i class="fa fa-link"></i> <span>Comments</span></a></li>-->
                <li class="treeview">
                ...
                <i class="fa fa-angle-left pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        <li><a href="<?=Url::to(['/area']);?>">Location Area</a></li>
                        <li><a href="<?=Url::to(['/cities']);?>">Location City</a></li>
                    </ul>
                </li>
